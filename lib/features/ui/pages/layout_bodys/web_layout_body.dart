...
import 'package:authorization_test_omega/features/ui/pages/layout_bodys/widgets/web_app_bar.dart';
import 'package:authorization_test_omega/features/ui/pages/layout_bodys/widgets/web_footer/web_footer.dart';
            ...
            Stack(
              children: [
                ...
                Container(
                  ...
                  decoration: constraints.maxWidth < 1200
                      ? const BoxDecoration(
                  ...
                  child: Padding(
                    padding: EdgeInsets.only(
                        top: mediaQuerySize.height * 0.2, left: mediaQuerySize.width * 0.1),
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Container(
                          constraints: const BoxConstraints(minWidth: 380, maxWidth: 470),
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: LinkButton(
                                            ...
                                            onTap: () {
                                              showCustomSnackBar(
                                                  context: context, content: 'Забыли пароль?');
                                            },
                                          ),
                                        ),
                                      ],
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        LinkButton(
                                          ...
                                          onTap: () {
                                            showCustomSnackBar(
                                                context: context, content: 'Зарегистрируйтесь');
                                          },
                                          textSize: 15,
